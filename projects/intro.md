...
**[Easy to Integrate Auth Frontend](/cloud/)** - Integrate embeddable Stytch, Cognito and/or Auth0 identity platform frontends in the [cloud repo](https://github.com/modelearth/cloud/).
