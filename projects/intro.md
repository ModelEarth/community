...
&bullet; [Pandoc blog install steps for SQLite chart](../../places/) - Node/npm install wiz needed
&bullet; [Display actual dollar totals](../../places/) - Boss React and matrix skills needed
