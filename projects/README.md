...
TO DO - Save settings and company commodity lists to GitHub for use in Life Cycle Analysis using a push similar to Code for America's [publiccode-pusher](https://codeforamerica.github.io/publiccode-pusher/).  
