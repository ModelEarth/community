...
## I. React - Select Goods and Services for environmental impacts, including carbon footprints

Edit our **profile-editor** fork of Italy's publiccode-pusher to save selected Goods and Services in a file called sectors.yml. Saved list will be used for Life Cycle Analysis (LCA) of company and individual carbon footprints. (Our fork will be available shortly, you can create your own fork while we wait for activation.)  
