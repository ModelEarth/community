...
def clean_data(file, year):
    ...
    file_name = 'poverty_' + year + '.csv'
    df.to_csv('../prep/poverty_clean/' + file_name, sep=',', columns=new_col_names, encoding='utf-8', index=False)
