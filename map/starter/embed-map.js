...
strVar += "";
strVar += "    <h1 class=\"shortTitle\" style=\"margin-bottom:0px; padding:8px 15px 4px 0; white-space: nowrap; float:left;\"><\/h1>";
strVar += "";
strVar += "    <div class=\"filterFields\" style=\"padding-top:10px;float:left\">";
...
strVar += "<\/aside>";
strVar += "";
strVar += "<div class=\"headerOffset\" style=\"height:68px\">&nbsp;<\/div>";
strVar += "";
