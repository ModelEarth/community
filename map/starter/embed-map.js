...
strVar += "        -->";
strVar += "        <input readonly id=\"catSearch\" class=\"filterClick mobileWide textInput\" placeholder=\"Lookup\" type=\"text\" autocomplete=\"off\" style=\"width: 200px; margin-top: 0px;\" \/>";
strVar += "      <\/div>";
strVar += "    <\/div>";
strVar += "";
...
strVar += "          style=\"padding-right:27px;\" class=\"filterClick mobileWide textInput si-input\" type=\"text\" value=\"\" onblurXX=\"SearchFormTextCheck(this, 0)\" onfocusXX=\"SearchFormTextCheck(this, 1)\" placeholderX=\"Search\" onkeyup=\"return SearchEnter(event);\" onkeypressX=\"return SearchEnter(event);\" \/>";
strVar += "      <\/div>";
strVar += "";
strVar += "    <\/div>";
strVar += "";
...
strVar += "                <div id=\"hideAdvanced\" style=\"float:right;cursor:pointer\">&#10005;<\/div>";
strVar += "";
...
strVar += "";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"in\" id=\"type\" checked>";
strVar += "                      <label for=\"type\" class=\"filterCheckboxTitle\"> In Type<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"in\" id=\"title\" checked>";
strVar += "                      <label for=\"title\" class=\"filterCheckboxTitle\"> In Title<\/label>";
strVar += "                    <\/div>";
strVar += "";
strVar += "";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findCompany\" id=\"findCompany\" value=\"1\" checked><label for=\"findCompany\" class=\"filterCheckboxTitle\"> In Company Name<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findWebsite\" id=\"findWebsite\" value=\"1\" checked><label for=\"findWebsite\" class=\"filterCheckboxTitle\"> In Website URL<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findKeywords\" id=\"findKeywords\" value=\"1\" checked><label for=\"findKeywords\" class=\"filterCheckboxTitle\"> In Keywords<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findDetails\" id=\"findDetails\" value=\"1\" checked><label for=\"findDetails\" class=\"filterCheckboxTitle\"> In Industry<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div>";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findProduct\" id=\"findProduct\" value=\"1\" checked><label for=\"findDetails\" class=\"filterCheckboxTitle\"> In Product Description<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div style=\"display:none\">";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findNews\" id=\"findNews\" value=\"1\"><label for=\"findNews\" class=\"filterCheckboxTitle\"> In Newsroom<\/label>";
strVar += "                    <\/div>";
strVar += "                    <div style=\"display:none\">";
strVar += "                      <input type=\"checkbox\" class=\"selected_col\" name=\"findContent\" id=\"findContent\" value=\"1\"><label for=\"findContent\" class=\"filterCheckboxTitle\"> In Georgia.org<\/label>";
strVar += "                    <\/div>";
strVar += "                <\/div>";
strVar += "              <\/div>";
strVar += "            <\/div>";
...
strVar += "            <div class=\"filterLabel filterLabelMain\">Where<\/div>";
strVar += "";
...
strVar += "                        <li data-id=\"country:us\"><a href=\"#\">USA<\/a><\/li>";
strVar += "                        <!--";
...
strVar += "                        ";
strVar += "                        ";
strVar += "                        <li data-id=\"city\"><a href=\"#\">Cities<\/a><\/li>";
...
strVar += "                        ";
strVar += "                    <\/ul>";
strVar += "                    <div style=\"float:left; border:1px solid #ccc;padding:20px;max-width:150px\">";
strVar += "                        <b>Mock-Up<\/b><br>";
strVar += "                        Lists to select countries, states\/provinces, counties, cities and postal\/zip codes will be displayed here.";
strVar += "                    <\/div>";
strVar += "                <\/div>";
strVar += "";
strVar += "            <\/div>";
...
strVar += "            <div class=\"filterLabel filterLabelMain\">Cities<\/div>";
strVar += "";
...
strVar += "            <div class=\"filterLabel filterLabelMain\">Latitude";
strVar += "            <\/div>";
...
strVar += "          <\/div>";
strVar += "          <div style=\"float:left; margin-right: 6px\">";
strVar += "            <div class=\"filterLabel filterLabelMain\">Longitude";
strVar += "            <\/div>";
...
strVar += "            <div class=\"filterLabel filterLabelMain\">Zip";
strVar += "            <\/div>";
...
strVar += "";
strVar += "          <select class=\"distance triggerSearch\">";
...
strVar += "    <br>";
strVar += "    HS Codes<br>";
strVar += "    <input id=\"productCodes\" class=\"filterClick mobileWide textInput\" placeholder=\"Lookup\" type=\"text\" autocomplete=\"off\" style=\"width: 120px; margin-top: 0px;\" onkeyup=\"return SearchProductCodes(event);\" \/>";
strVar += "";
strVar += "    <div id=\"topPanelFooter\">Show more<\/div>";
strVar += "  <\/div>";
strVar += "<\/div>";
...
strVar += "            border-bottom: 1px solid #eee;";
strVar += "            width:100%;";
strVar += "          }";
strVar += "          .pagebutton {";
strVar += "            background:#4586F6;";
strVar += "            background: #bbb;";
strVar += "            margin-right: 8px;";
strVar += "            color:#fff;";
strVar += "            border-radius: 5px;";
strVar += "            padding: 0px 8px 0 10px;";
...
strVar += "            background-color:#7a7a7a;";
strVar += "          }";
strVar += "          .listOptions {";
strVar += "            display:none;";
...
strVar += "";
strVar += "          <div class=\"pagebuttonHolder\" style=\"min-height:45px; overflow: visible;\">";
...
strVar += "";
strVar += "              <div class=\"toggleListOptions pagebutton\" style=\"padding:2px\"><i class=\"material-icons toggleArrow\" style=\"font-weight:900; font-size: 32px; padding:0px; margin:0px\">&#xE5C5;<\/i>";
strVar += "              <\/div>";
strVar += "";
