...
strVar += "";
strVar += "   ";
strVar += "    <div class=\"content filters-marginX margin-leftX:20px\">";
...
strVar += "";
strVar += "";
strVar += "        <div class=\"content contentpadding\">";
strVar += "          <div style=\"overflow: visible;\">";
strVar += "";
strVar += "            <div class=\"pagebuttonHolder\" style=\"min-height:45px; overflow: visible;\">";
strVar += "";
strVar += "              <!-- class=\"showApps\" menu.json -->";
strVar += "              <i style=\"display:none;font-size:30px; color:#ccc; float:left; padding:10px 4px 4px 0px\" class=\"local material-icons\">&#xE5C3;<\/i>";
strVar += "";
