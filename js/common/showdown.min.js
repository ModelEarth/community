...
function loadMarkdown(pagePath, divID, target) {
  ...
  d3.text(pagePath).then(function(data) {
    // Path is replaced further down page.
    var pencil = "<div class='markdownEye' style='position:absolute;font-size:18px;right:16px;text-decoration:none'><a href='" + pagePath + "'>&#x1f441;</a></div>";
